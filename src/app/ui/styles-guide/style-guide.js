...
function styleGuide () {
  ...
  var cssProperties = {
    ...
    colors: {
      ...
      // TESTNET COLURS
      bgColour: '#121326',
      primaryColour: '#709cf0',
      primaryColourLight: '#9fbbee',
      secondaryColour: '#832dc4',
      secondaryColourLight: '#d5bde6'
    },
  ...
  var appProperties = {
    ...
    /* ------------------------------------------------------
                          BACKGROUND COLORS
    ------------------------------------------------------ */
    primary_BackgroundColor: cssProperties.colors.bgColour,
    secondary_BackgroundColor: cssProperties.colors.secondaryColourLight,
    tertiary_BackgroundColor: cssProperties.colors.secondaryColourLight,
    quaternary_BackgroundColor: cssProperties.colors.secondaryColourLight,
    fifth_BackgroundColor: cssProperties.colors.secondaryColourLight,
    seventh_BackgroundColor: cssProperties.colors.veryLightGrey,
    dark_BackgroundColor: cssProperties.colors.bgColour,
    light_BackgroundColor: cssProperties.colors.white,
    debuggingMode_BackgroundColor: cssProperties.colors.secondaryColourLight,
    ...
    ******************************************************** */
    ...
    /* .................
          PRIMARY
    .................. */
    primaryButton_TextColor: cssProperties.colors.bgColour,
    primaryButton_BackgroundColor: cssProperties.colors.primaryColour,
    primaryButton_BorderColor: cssProperties.colors.primaryColour,

    /* .................
          SECONDARY
    .................. */
    secondaryButton_TextColor: cssProperties.colors.bgColour,
    secondaryButton_BackgroundColor: cssProperties.colors.primaryColourLight,
    secondaryButton_BorderColor: cssProperties.colors.primaryColourLight,

    /* .................
          Teriary
    .................. */
    teriaryButton_TextColor: cssProperties.colors.bgColour,
